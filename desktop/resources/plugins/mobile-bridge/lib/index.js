...
import { SCOPE_LABELS, SCOPES, consumePairing, deviceForToken, deviceView, issuePairing, newToken, readStore, scopeAllows, storePath, writeStore, } from './devices.js';
import { buildDoc, engineOps, mergeDocs, overlayFor, } from './models.js';
                    ...
                    onMessage: (client, text) => {
                        try {
                            ...
                            if (parsed.type === 'hello') {
                                ...
                                if (state !== undefined)
                                    state.since = Number.isFinite(since) ? since : 0;
