...
# Debian/Ubuntu
sudo apt install ./DeepSeek-0.2.5-linux-amd64.deb
```

Windows：下载 `DeepSeek-0.2.5-win.exe`。若 SmartScreen 提示未签名，选「更多信息 → 仍要运行」。
...
- Linux：
  - `https://dsh.zhuquan.xyz/dl/DeepSeek-0.2.5-linux-x64.tar.gz`
  - `https://dsh.zhuquan.xyz/dl/DeepSeek-0.2.5-linux-amd64.deb`
  - `https://dsh.zhuquan.xyz/dl/DeepSeek-0.2.5-linux-arm64.tar.gz`
  - `https://dsh.zhuquan.xyz/dl/DeepSeek-0.2.5-linux-arm64.deb`

请用 **0.2.5**。不要用 0.1.0–0.1.19。安装包优先从 https://dsh.zhuquan.xyz/dl/ 下载。
